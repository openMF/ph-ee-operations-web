...
export let environment = {
  ...
  backend: {
    operations: window['env']['serverApiUrlOps'] || 'http://ops.mifos.gazelle.localhost/api/v1',
    signatureApiUrl: window['env']['signatureApiUrl'] || 'https://ops.mifos.gazelle.localhost/api/v1/util/x-signature',
    bulkConnectorOps: window['env']['bulkConnectorOps'] || 'https://ops.mifos.gazelle.localhost',
    vouchers: window['env']['serverApiUrlVou'] || 'http://ops.mifos.gazelle.localhost/api/v1',
    voucherCallbackUrl: window['env']['callbackUrlVou'] || 'https://webhook.site/',
    account: window['env']['serverApiUrlAct'] || 'http://ops.mifos.gazelle.localhost/api/v1',
  ...
  oauth: {
    ...
    serverUrl: window['env']['oauthServerUrl'] || 'http://keycloak.mifos.gazelle.localhost/auth',
  ...
  tenant: window['env']['platformTenantId'] || 'greenbank',
  tenants: window['env']['platformTenantIds'] || 'greenbank,bluebank,redbank',
