...
/**
 * Incoming Ig2 Files component.
 */
@Component({
  selector: 'mifosx-incoming-ig2-files',
  templateUrl: './incoming-ig2-files.component.html',
  styleUrls: ['./incoming-ig2-files.component.scss']
})
export class IncomingIg2FilesComponent implements OnInit, AfterViewInit {
  ...
  constructor(private ig2FilesService: Ig2FilesService,
    ...
    private formBuilder: FormBuilder) {
      ...
      this.route.queryParams.subscribe(params => {
        ...
        if (fileId) {
          this.stateService.clearState('incoming-ig2-files');
  ...
  ngAfterViewInit() {
    const storedState = this.stateService.getState('incoming-ig2-files');
    if (storedState) {
    ...
    merge(this.sort.sortChange, this.paginator.page)
      .pipe(
        tap(() => {
          ...
          this.stateService.setState('incoming-ig2-files', this.filterFormGroup, this.filterIg2FilesBy, this.sort, this.paginator);
        })
        )
      .subscribe();
