...
/**
 * G2P Payment Configs resolver.
 */
@Injectable()
export class G2PPaymentConfigsResolver {
    ...
    /**
     * Returns the G2p Payment Configs data.
     * @returns {Observable<any>}
     */
    resolve(): Observable<any> {
        return this.g2pPaymentConfigService.getG2pPayments();
    }
